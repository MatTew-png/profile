 ...
 * Glowing SVG laser line that traces scroll progress alongside content.
 */
    ...
    >
      <div className="absolute -left-4 md:-left-12 top-3">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-cyan-400/40 shadow-sm flex items-center justify-center bg-slate-950"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? '#38bdf8' : '#10b981',
              borderColor:
                scrollYProgress.get() > 0 ? '#38bdf8' : '#10b981',
            }}
